...
def page_partners():
  ...
  <div class="wrap prose">
    ...
    <div class="grid cols-2" style="margin-top:14px">
      ...
      <div class="card"><h3>Slaap Zorgeloos</h3><p style="margin-bottom:14px">Slaap Zorgeloos is een Belgische blog over slapen, met artikelen over slaaphoudingen, de slaapkamer, ontspanning en de betekenis van dromen.</p><a class="more" href="https://slaapzorgeloos.be/slaaptips/beste-slaaphouding-welke-positie-is-het-gezondst/" target="_blank" rel="noopener">beste slaaphouding {IC['arrow']}</a></div>
      <div class="card"><h3>Zorgbroeder</h3><p style="margin-bottom:14px">Zorgbroeder levert hulpmiddelen voor buiten de deur: driewielfietsen, duofietsen, scootmobielen en rollators, met advies, halen en brengen, reparatie en onderhoud.</p><a class="more" href="https://zorgbroeder.nl/driewielfietsen/ouderen" target="_blank" rel="noopener">Driewieler fiets voor ouderen {IC['arrow']}</a></div><div class="card"><h3>Frecious</h3><p style="margin-bottom:14px">Frecious maakt koudgeperste sappen en shots van verse groenten en fruit, zonder toevoegingen, als praktische aanvulling op een gezonde levensstijl.</p><a class="more" href="https://www.frecious.bio/health-shots/gembershot" target="_blank" rel="noopener">Gembershot {IC['arrow']}</a></div><div class="card"><h3>Brahman Menor</h3><p style="margin-bottom:14px">Brahman Menor schrijft over spiritualiteit en bewustwording, met artikelen over onder meer ontspanning en aandacht voor het eigen gevoel.</p><a class="more" href="https://brahmanmenor.com/spiritueel/innerlijke-rust/" target="_blank" rel="noopener">Rust in je hoofd {IC['arrow']}</a></div><div class="card"><h3>Mobiliteit Expert</h3><p style="margin-bottom:14px">Mobiliteit Expert biedt een uitgebreid assortiment mobiliteitshulpmiddelen, waaronder rollators van gerenommeerde merken.</p><a class="more" href="https://mobiliteitexpert.nl/mobiliteit/rollator/drive/nitro" target="_blank" rel="noopener">Rollator drive nitro {IC['arrow']}</a></div><div class="card"><h3>Medical Chairs</h3><p style="margin-bottom:14px">Medical Chairs levert ergonomische zadelkrukken die een actieve zithouding ondersteunen, wat kan bijdragen aan minder rugklachten tijdens langdurig zitwerk.</p><a class="more" href="https://www.medicalchairs.nl/nl/producten/zadelkrukken/" target="_blank" rel="noopener">zadelkrukken {IC['arrow']}</a></div><div class="card"><h3>Rooted in Change</h3><p style="margin-bottom:14px">Rooted in Change schrijft over koud douchen en ijsbaden, met uitleg over de effecten op stress, weerstand en discipline, en een stappenplan om er rustig mee te beginnen.</p><a class="more" href="https://www.rootedinchange.nl/" target="_blank" rel="noopener">Rootedinchange.nl {IC['arrow']}</a></div>
